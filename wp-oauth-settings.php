	...
	<div id="wpoa-settings-body">
		...
		<div id="wpoa-settings-col1" class="wpoa-settings-column">
			<form method='post' action='options.php'>
				...
				<!-- START Login with Musicalrainbows section -->
				<div id="wpoa-settings-section-login-with-musicalrainbows" class="wpoa-settings-section">
					<h3>Login with Musicalrainbows</h3>
					<div class='form-padding'>
						<table class='form-table'>
							<tr valign='top'>
								<th scope='row'>Enabled:</th>
								<td>
									<input type='checkbox' name='wpoa_musicalrainbows_api_enabled' value='1' <?php checked(get_option('wpoa_musicalrainbows_api_enabled') == 1); ?> />
								</td>
							</tr>
							...
							<tr valign='top'>
								<th scope='row'>Client ID:</th>
								<td>
									<input type='text' name='wpoa_musicalrainbows_api_id' value='<?php echo get_option('wpoa_musicalrainbows_api_id'); ?>' />
								</td>
							</tr>
							...
							<tr valign='top'>
								<th scope='row'>Client Secret:</th>
								<td>
									<input type='text' name='wpoa_musicalrainbows_api_secret' value='<?php echo get_option('wpoa_musicalrainbows_api_secret'); ?>' />
								</td>
							</tr>
						</table> <!-- .form-table -->
						<p>
							<strong>Instructions:</strong>
						<ol>
							<li>Ask  <a href='https://api.slack.com/apps' target="_blank">https://www.musicalrainbows.be</a> to give you permission to use API.</li>
							<li>Provide your site's homepage URL (<?php echo $blog_url; ?>) for the new App's Redirect URI. Don't forget the trailing slash!</li>
							<li>Paste your Client ID/Secret provided by Musicalrainbows into the fields above, then click the Save all settings button.</li>
						</ol>
						</p>
						<?php submit_button('Save all settings'); ?>
					</div> <!-- .form-padding -->
				</div> <!-- .wpoa-settings-section -->
				<!-- END Login with Musicalrainbows section -->
